...
pub fn execute(instruction: DecodedInstruction, cpu: *CPUState, _: *Memory) !void {
    switch (instruction) {
        .ADD => |x| {
            if (x.rd != 0) {
...
// pub fn oldexecute(instruction: Instruction, cpuState: *CPUState, memory: *Memory) !void {
